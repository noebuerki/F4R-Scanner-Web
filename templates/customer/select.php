    ...
    <div class="container">
        <div class="row row-cols-2 row-cols-md-4 justify-content-center">
            ...
            foreach ($customers as $customer) {
                echo '
            <div class="col">
                <a href="/customer/update?customerId=' . $customer->id . '" role="button" class="btn btn-primary bg-primary w-100 mb-4">
    ...
    <div class="container">
        <div class="row position-fixed fixed-buttonpos">
            ...
            <a href="/customer/search?firstName=<?php echo $firstName ?>&lastName=<?php echo $lastName ?>"
               role="button" class="mr-3 btn btn-secondary" data-toggle="tooltip" title="Back to search">
